...
<head>
    ...
    <title>Two-Factor Authentication — {{ config('app.name', 'E-Services') }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-primary-custom:hover { background: #163059; }
...
<div class="auth-card">
    ...
    <div class="icon-ring">
        <i class="bi bi-shield-lock-fill" style="color:#93C5FD;font-size:1.4rem;"></i>
    </div>

    <h1>Two-Factor Authentication</h1>

    @if(session('status'))
        <p class="subtitle">Code sent — check your email inbox.</p>
    ...
    @else
        <p class="subtitle">A 6-digit verification code was sent to your email address.</p>
    @endif
    ...
    <div style="text-align:center;">
        <p style="color:#64748B;font-size:0.82rem;margin-bottom:0.6rem;">Can't access your app?</p>
        <form method="POST" action="{{ route('2fa.resend') }}">
            @csrf
            <button type="submit" class="btn-outline-custom">
                <i class="bi bi-envelope me-1"></i> Send code to email instead
            </button>
        </form>
    </div>
