    ...
    <div class="col-xl-8 col-lg-10">
        ...
        <div class="mb-4">
            ...
            <p style="color:var(--muted);font-size:0.875rem;margin-top:4px;">
                Fill in the details below to register a new government office.
            </p>
        </div>
        ...
        <form action="{{ route('admin.offices.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-5">
                        ...
                        @error('code')
                            <div style="font-size:0.78rem;color:#f87171;margin-top:4px;">{{ $message }}</div>
                        @enderror
                        <div style="font-size:0.75rem;color:var(--muted);margin-top:4px;">Unique short identifier (optional)</div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="Brief description of what this office handles…">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label class="form-label-custom">
                            Pin Office on Map
                            <span style="font-weight:400;color:var(--muted);margin-left:4px;">(optional — click to place marker)</span>
                        </label>
                        ...
                        <div id="coords-display"
                             style="font-size:0.75rem;color:var(--muted);margin-top:6px;display:none;">
            ...
            <div class="admin-card mb-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="working_days" value="{{ old('working_days') }}"
            ...
            <div class="d-flex gap-3 justify-content-end">
                ...
                <button type="submit" class="btn-gold">
                    <i class="bi bi-floppy-fill"></i> Save Office
                </button>
            </div>
        </form>
